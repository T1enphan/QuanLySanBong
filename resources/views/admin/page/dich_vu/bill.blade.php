...
<body>
    ...
    <div id="invoice-POS">
        ...
        <div id="mid">
            <div class="info">
                <h2 class="text-center mt-3">{{$TamTinh}}</h3>
                    {{-- <p style="15px">
                        Địa Chỉ : Đà Nẵng</br>
            ...
            <div id="table">
                <table>
                    ...
                    <tr class="service">
                        ...
                        <td class="tableitem">
                            <p class="itemtext text-nowrap">{{ $value->don_gia_ban }}</p>
                        </td>
                ...
                <div>
                    <table>
                        ...
                        <tr class="service">
                            ...
                            <td class="tableitem">
                                <p class="itemtext">{{ number_format($tong_tien, 0) }} đ <span><i>({{ $tt_chu }})</i></span></p>
                            </td>
                        </tr>
                    </table>
                </div>
