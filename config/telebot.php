...
return [
    ...
    */
    ...
    'bots' => [
        'bot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '6458445725:AAGbdN3wghCfqx6Hgm4pjv4gRB7JPg8NflI'),
            'name' => env('TELEGRAM_BOT_NAME', 'QuanLySanBong_BOT'),
            'api_url' => env('TELEGRAM_API_URL', 'https://api.telegram.org/bot{6458445725:AAGbdN3wghCfqx6Hgm4pjv4gRB7JPg8NflI}/{post}'),
            'exceptions' => true,
            'async' => false,
